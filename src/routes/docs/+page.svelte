...
<main class="mx-auto max-w-3xl px-6 py-16 md:py-24">
	...
	<section class="border-surface-200-800 mt-8 border-y py-6" aria-label="About these docs">
		<p class="text-surface-700 dark:text-surface-300 leading-relaxed">
			...
			Production is the on-cluster adapter-node deployment behind the Cloudflare tunnel (ADR 0008); the ADR 0010 cutover
			is complete and Cloudflare Pages has been retired. For the serving topology and the mail-stack port map, see the
