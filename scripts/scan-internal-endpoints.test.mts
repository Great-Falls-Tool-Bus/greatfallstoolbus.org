...
// a phantom 5th octet, so real 4-octet addresses like 192.168.0.11 and
...
describe('scan-internal-endpoints private-IP guard', () => {
	it('flags 192.168.0.0/16 addresses (regression: 192.168.0.11 slipped past)', () => {
		const addr = ip(192, 168, 0, 11);
